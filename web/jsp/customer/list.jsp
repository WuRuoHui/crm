								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												共[<B><s:property value="#pageBean.totalCount"></s:property> </B>]条记录,[<B><s:property value="#pageBean.totalPage"></s:property></B>]页
												,每页显示
												<select name="pageSize" onchange="changePageSize($('#pageSizeChange option:selected').val())" id="pageSizeChange">
												...
												条
												[<A href="javascript:void(0)" onclick="changePage(<s:property value='#pageBean.currentPage-1'></s:property>)">前一页</A>]
												<B><s:property value="#pageBean.currentPage"></s:property></B>
												[<A href="javascript:void(0)" onclick="changePage(<s:property value='#pageBean.currentPage+1'></s:property>)">后一页</A>]
												到
												<input type="text" size="3" id="page" name="page" value="<s:property value='#pageBean.currentPage'></s:property>"/>
												页
